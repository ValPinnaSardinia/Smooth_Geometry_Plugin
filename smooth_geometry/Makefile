...
SOURCES = \
	__init__.py \
	smooth_geometry.py smooth_geometry_dialog.py

PLUGINNAME = smooth_geometry

PY_FILES = \
	__init__.py \
	smooth_geometry.py smooth_geometry_dialog.py

UI_FILES = smooth_geometry_dialog_base.ui
...
QGISDIR=C:\Users\pinna\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
